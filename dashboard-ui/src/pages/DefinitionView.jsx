...
//       setSelectedWord({ ...selectedWord, ...editData });
//       setIsEditing(false);
//       setHasUnsavedChanges(false);
...
//         <p>View and edit definitions, translations, and word structures</p>
//       </div>
...
//                     {isEditing ? (
//                       <div className="word-structure-edit">
//                         {Object.entries(editData.word_structure).map(([key, value]) => (
//                           <div key={key} className="structure-edit-item">
//                             <label>{key}:</label>
//                             <input
//                               type="text"
//                               value={value}
//                               onChange={(e) => {
//                                 const newWordStructure = {...editData.word_structure};
//                                 newWordStructure[key] = e.target.value;
//                                 setEditData(prev => ({...prev, word_structure: newWordStructure}));
//                                 setHasUnsavedChanges(true);
//                               }}
...
//                       </div>
//                     ) : (
//                       <div className="word-structure-display">
...
//                 <p>Click on a domain word from the list to view and edit its definition details</p>
//               </div>
//             )}
//           </div>
//         </div>
